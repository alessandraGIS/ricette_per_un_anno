...
window.MARA_RECIPES = {
  ...
  recipes: {
    ...
    tabuleh: {
      ...
      ing: {
        it: ["300 g di bulgur fine oppure cous cous precotto", "400 g di pomodori datterini", "200 g di cipolle", "150 g di peperone verde", "abbondante prezzemolo fresco", "1 manciata di foglie di menta fresca", "3 limoni", "acqua, quanto basta per arrivare a 300 g insieme al succo dei limoni", "½ cucchiaino di cumino in polvere (facoltativo)", "50 g di olio extravergine d'oliva", "sale"],
        en: ["300 g fine bulgur or precooked couscous", "400 g datterini tomatoes", "200 g onions", "150 g green pepper", "plenty of fresh parsley", "1 handful of fresh mint leaves", "3 lemons", "water, enough to reach 300 g together with the lemon juice", "½ tsp ground cumin (optional)", "50 g extra-virgin olive oil", "salt"]
      },
      steps: {
        it: ["Spremi i 3 limoni e pesa il succo. Aggiungi acqua fino a ottenere 300 g complessivi di liquido.", "Versa il bulgur fine o il cous cous precotto in una terrina, bagnalo con il liquido preparato e lascialo gonfiare, coperto, per circa un'ora.", "Nel frattempo lava e asciuga i datterini e tagliali a metà. Monda le cipolle e affettale molto sottilmente. Pulisci il peperone e taglialo a piccoli dadini.", "Quando il bulgur o il cous cous sarà ben gonfio, sgranalo con una forchetta, quindi aggiungi i datterini, la cipolla e il peperone.", "Unisci abbondante prezzemolo e le foglie di menta tritati. Aggiungi anche il cumino in polvere, se lo usi.", "Condisci con l'olio extravergine d'oliva e il sale e mescola bene.", "Lascia riposare il tabuleh in frigorifero prima di servirlo."],
        en: ["Squeeze the 3 lemons and weigh the juice. Add water until you have 300 g of liquid in total.", "Put the fine bulgur or the precooked couscous in a bowl, moisten it with the liquid you prepared and let it swell, covered, for about an hour.", "Meanwhile wash and dry the datterini tomatoes and cut them in half. Peel the onions and slice them very thinly. Clean the pepper and cut it into small dice.", "When the bulgur or couscous has swelled nicely, loosen it with a fork, then add the tomatoes, the onion and the pepper.", "Add plenty of chopped parsley and mint leaves. Add the ground cumin too, if you are using it.", "Dress with the extra-virgin olive oil and the salt and mix well.", "Let the tabbouleh rest in the fridge before serving."]
      },
      notes: [
